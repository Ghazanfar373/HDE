    ...
    struct _JSBSim_fdmdata *to)
{
    ...
    to->FuelExpanded = (c_double)from->FuelExpanded;
    to->AOAGreenFlag = (c_bool)from->AOAGreenFlag;
    to->AOAAmberFlag = (c_bool)from->AOAAmberFlag;
    to->AOARedFlag = (c_bool)from->AOARedFlag;
    to->HSI_Compass_Heading = (c_double)from->HSI_Compass_Heading;
    to->h_agl_flag_status = (c_bool)from->h_agl_flag_status;
    to->roll_deg = (c_double)from->roll_deg;
    to->pitch_deg = (c_double)from->pitch_deg;
    to->v_down_fpm = (c_double)from->v_down_fpm;
    return result;
}
    ...
    void *_to)
{
    ...
    to->FuelExpanded = (::DDS::Double)from->FuelExpanded;
    to->AOAGreenFlag = (::DDS::Boolean)from->AOAGreenFlag;
    to->AOAAmberFlag = (::DDS::Boolean)from->AOAAmberFlag;
    to->AOARedFlag = (::DDS::Boolean)from->AOARedFlag;
    to->HSI_Compass_Heading = (::DDS::Double)from->HSI_Compass_Heading;
    to->h_agl_flag_status = (::DDS::Boolean)from->h_agl_flag_status;
    to->roll_deg = (::DDS::Double)from->roll_deg;
    to->pitch_deg = (::DDS::Double)from->pitch_deg;
    to->v_down_fpm = (::DDS::Double)from->v_down_fpm;
}
