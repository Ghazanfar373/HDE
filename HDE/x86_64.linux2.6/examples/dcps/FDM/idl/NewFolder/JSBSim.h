...
namespace JSBSim
{
   ...
   struct fdmdata
   {
      ...
      DDS::Double FuelExpanded;
      DDS::Boolean AOAGreenFlag;
      DDS::Boolean AOAAmberFlag;
      DDS::Boolean AOARedFlag;
      DDS::Double HSI_Compass_Heading;
      DDS::Boolean h_agl_flag_status;
      DDS::Double roll_deg;
      DDS::Double pitch_deg;
      DDS::Double v_down_fpm;
   };
