...
//  Generated: Wed May 23 13:27:20 2012
...
namespace DDS
{
   ...
   public:
      ...
      virtual InstanceHandle_t register_instance (const ParticipantBuiltinTopicData& instance_data) = 0;
      virtual InstanceHandle_t register_instance_w_timestamp (const ParticipantBuiltinTopicData& instance_data, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t unregister_instance (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t unregister_instance_w_timestamp (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t write (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t write_w_timestamp (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t dispose (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t dispose_w_timestamp (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t writedispose (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t writedispose_w_timestamp (const ParticipantBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t get_key_value (ParticipantBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const ParticipantBuiltinTopicData& instance_data) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t read (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_w_condition (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_w_condition (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t read_next_sample (ParticipantBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t take_next_sample (ParticipantBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t read_instance (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_instance (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_next_instance (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance_w_condition (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_next_instance_w_condition (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t return_loan (ParticipantBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq) = 0;
      virtual ReturnCode_t get_key_value (ParticipantBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const ParticipantBuiltinTopicData& instance) = 0;
   ...
   public:
      ...
      virtual InstanceHandle_t register_instance (const TopicBuiltinTopicData& instance_data) = 0;
      virtual InstanceHandle_t register_instance_w_timestamp (const TopicBuiltinTopicData& instance_data, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t unregister_instance (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t unregister_instance_w_timestamp (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t write (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t write_w_timestamp (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t dispose (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t dispose_w_timestamp (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t writedispose (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t writedispose_w_timestamp (const TopicBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t get_key_value (TopicBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const TopicBuiltinTopicData& instance_data) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t read (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_w_condition (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_w_condition (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t read_next_sample (TopicBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t take_next_sample (TopicBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t read_instance (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_instance (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_next_instance (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance_w_condition (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_next_instance_w_condition (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t return_loan (TopicBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq) = 0;
      virtual ReturnCode_t get_key_value (TopicBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const TopicBuiltinTopicData& instance) = 0;
   ...
   public:
      ...
      virtual InstanceHandle_t register_instance (const PublicationBuiltinTopicData& instance_data) = 0;
      virtual InstanceHandle_t register_instance_w_timestamp (const PublicationBuiltinTopicData& instance_data, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t unregister_instance (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t unregister_instance_w_timestamp (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t write (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t write_w_timestamp (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t dispose (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t dispose_w_timestamp (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t writedispose (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t writedispose_w_timestamp (const PublicationBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t get_key_value (PublicationBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const PublicationBuiltinTopicData& instance_data) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t read (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_w_condition (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_w_condition (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t read_next_sample (PublicationBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t take_next_sample (PublicationBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t read_instance (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_instance (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_next_instance (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance_w_condition (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_next_instance_w_condition (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t return_loan (PublicationBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq) = 0;
      virtual ReturnCode_t get_key_value (PublicationBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const PublicationBuiltinTopicData& instance) = 0;
   ...
   public:
      ...
      virtual InstanceHandle_t register_instance (const SubscriptionBuiltinTopicData& instance_data) = 0;
      virtual InstanceHandle_t register_instance_w_timestamp (const SubscriptionBuiltinTopicData& instance_data, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t unregister_instance (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t unregister_instance_w_timestamp (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t write (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t write_w_timestamp (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t dispose (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t dispose_w_timestamp (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t writedispose (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle) = 0;
      virtual ReturnCode_t writedispose_w_timestamp (const SubscriptionBuiltinTopicData& instance_data, InstanceHandle_t handle, const Time_t& source_timestamp) = 0;
      virtual ReturnCode_t get_key_value (SubscriptionBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const SubscriptionBuiltinTopicData& instance_data) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t read (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_w_condition (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_w_condition (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t read_next_sample (SubscriptionBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t take_next_sample (SubscriptionBuiltinTopicData& received_data, SampleInfo& sample_info) = 0;
      virtual ReturnCode_t read_instance (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_instance (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t take_next_instance (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, SampleStateMask sample_states, ViewStateMask view_states, InstanceStateMask instance_states) = 0;
      virtual ReturnCode_t read_next_instance_w_condition (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t take_next_instance_w_condition (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq, Long max_samples, InstanceHandle_t a_handle, ReadCondition_ptr a_condition) = 0;
      virtual ReturnCode_t return_loan (SubscriptionBuiltinTopicDataSeq& received_data, SampleInfoSeq& info_seq) = 0;
      virtual ReturnCode_t get_key_value (SubscriptionBuiltinTopicData& key_holder, InstanceHandle_t handle) = 0;
      virtual InstanceHandle_t lookup_instance (const SubscriptionBuiltinTopicData& instance) = 0;
